    ...
    <div class="bg-white rounded-[2.5rem] p-8 max-w-sm w-full shadow-2xl">
        <div class="text-center">
            ...
            <div class="flex flex-col gap-3">
                <button type="button" onclick="executeSubmit()" id="btnConfirm" class="w-full bg-gray-900 text-white py-4 rounded-2xl font-bold hover:bg-blue-600 transition">
                    Confirm & Pay
                </button>
                <button type="button" onclick="toggleModal('confirmModal', false)" class="w-full bg-gray-100 text-gray-500 py-4 rounded-2xl font-bold hover:bg-gray-200 transition">
                    Cancel
                </button>
            </div>
        </div>
...
<div id="successModal" class="hidden fixed inset-0 z-[60] items-center justify-center bg-black/60 backdrop-blur-sm p-4">
    <div class="bg-white rounded-[2.5rem] p-8 max-w-sm w-full shadow-2xl">
        <div class="text-center">
            ...
            <button type="button" onclick="window.location.href='{{ route('dashboard') }}'" class="w-full bg-green-600 text-white py-4 rounded-2xl font-bold hover:bg-green-700 transition">
                Back to Menu
            </button>
        </div>
    </div>
